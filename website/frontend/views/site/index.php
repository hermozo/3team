...
<div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<div id="home" class="first-section" style="background-image: url('<?= Yii::$app->media->baseUrl ?>/images/bg.jpg');
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<img src="<?= Yii::$app->media->baseUrl ?>/images/logo-oficial.png" alt="image">
									<h2 data-animation="animated zoomInRight">Cursos en <strong>Desarrollo Web</strong></h2>
			...
			<div class="item">
				<div id="home" class="first-section" style="background-image: url('<?= Yii::$app->media->baseUrl ?>/images/yii2.jpg');
					background-position: center;
					background-size: cover;
					background-repeat: no-repeat;">
					<div class="container">
						<div class="row">
							<div class="col-md-12 col-sm-12 text-center">
								<div class="big-tagline">
									<img src="<?= Yii::$app->media->baseUrl ?>/images/logo-yii.png" alt="image" style="max-width: 350px;" >
			...
			<div class="item">
				<div id="home" class="first-section" style="background-image:url('<?= Yii::$app->media->baseUrl ?>/images/about.jpg');
					background-position: center;
					background-size: cover;
					background-repeat: no-repeat;">
					<div class="container">
    ...
    <div id="overviews" class="section wb" style="background-image: url(<?= Yii::$app->media->baseUrl ?>/images/bg-op.jpg); background-size:cover; background-position: center; background-attachment: fixed;">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="message-box">
						...
						<a href="<?= \yii\helpers\Url::to(['about']) ?>" data-scroll class="btn btn-light btn-radius btn-brd grd1 effect-1">Leer mas</a>
                    </div><!-- end messagebox -->
                </div><!-- end col -->
				
				<div class="col-md-6">
                    <div class="post-media wow fadeIn">
                        <img src="<?= Yii::$app->media->baseUrl ?>/images/slider-04.jpg" alt="" class="img-responsive img-rounded">
            ...
            <div class="row text-center">
                <div class="col-md-5 col-sm-12">
                    <div class="customwidget text-left">
						...
						<p>Además aprenderás los principales lenguajes de programación usados en la actualidad. Programar sitios dinámicos que interactúen con bases de datos. Conocer la integración de lenguajes y herramientas de desarrollo que permiten realizar sitios multiplataforma.</p>
                        <!-- end list -->
                ...
                <div class="col-md-7">
                    <div class="post-media wow fadeIn">
                        <img src="<?= Yii::$app->media->baseUrl ?>/images/cursos1.jpg" alt="" class="img-responsive img-rounded">
            ...
            <div class="row dev-list text-center">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                    <div class="widget clearfix">
                        <img src="<?= Yii::$app->media->baseUrl ?>/images/pagina-web5.png" alt="" class="img-responsive">
                        ...
                        <hr>
                        <a href="#" data-scroll class="btn btn-light grd1 effect-1 btn-radius btn-brd">Ver más</a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                    <div class="widget clearfix">
                        <img src="<?= Yii::$app->media->baseUrl ?>/images/app-moviles.jpg" alt="" class="img-responsive">
                        <div class="widget-title">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                    <div class="widget clearfix">
                        <img src="<?= Yii::$app->media->baseUrl ?>/images/sis-inf2.jpg" alt="" class="img-responsive">
                        <div class="widget-title">
